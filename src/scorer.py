...
台股校準：最新、第一手的證交所全市場指數、市值或市場廣度資料，若可讓一般投資人立即比較同期間報酬或產業曝險，屬廣泛公共投資資訊，通常可評 0.70–0.82。單一公司的上市申請、法說場地、恢復交易方法等程序公告，若沒有跨市場、監管或大量投資人後果，confidence_score 不得高於 0.65。不要讓法條與公司代號的數據密度，使狹窄程序公告高於全市場 benchmark。

硬上限：政府宣傳活動、競賽、開幕、拜會、造勢到場人數或單純政客發言，若沒有改變任何人的金錢、安全、權利、公共服務、工作、食物、投資或已核定政策，confidence_score 不得高於 0.55。日期、人數與主辦機關只能證明活動存在，不能代替公共影響。若無法指出一名具體受影響者及其可採取的下一步，confidence_score 不得高於 0.60。
